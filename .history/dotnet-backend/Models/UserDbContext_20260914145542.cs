...
namespace dotnet_backend.Models
{
    public class UserDbContext
    {
      ...
      //3. Define the User class to represent the User entity with its properties and attributes. The role property is added to store user roles (Admin/User) for authorization purposes.
        public class User
        {
