...
export class Login {
  ...
  private users = new Map<string, UserRecord>([
    ['email123@gmail.com', { username: 'Admin', passwordHash: '123456abc', twofaEnabled: false }],
    ['email54@gmail.com', { username: 'Secretary', passwordHash: '98765xyz', twofaEnabled: true }]
  ]);
